...
$table='deckcards';  //table to delete values from
$msg='';  //this is an empty message initially
//$_SESSION['validID']=FALSE; //reset to FALSE 
	
//get the values entered in the form
//$cardID=$conn->real_escape_string($_POST['cardID']);//HERE!!!!!!!!!!!!!!
//$_SESSION['card_id']=$cardID;

$deckcardsID = $_POST['deckcardID'];

//Construct Query strings
$sqlData= "SELECT * FROM $table WHERE deckcard_id='$deckcardsID' ";

$sqlTitles = "SELECT column_name as Field
from `information_schema`.`columns` 
where `table_schema` = 'k00223356_duelnetwork' and `table_name` in ('deckcards')
and `column_name` in ('card_name')";  //get the table column descriptions
