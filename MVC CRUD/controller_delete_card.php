...
if(isset($_POST['btn_select_for_deletion'])){	
			...
			include("MODELS/model_delete_confirm_card.php");
			include("VIEWS/view_delete_confirm_card.php");
			}
...
elseif(isset($_POST['btn_confirm_delete'])){
			...
			include("LIBRARY/helperFunctionsDatabase.php");
			include("LIBRARY/helperFunctionsTables.php");
			include("MODELS/model_delete_commit_card.php");
			include("VIEWS/view_delete_commit_card.php");
			echo 'OK';
